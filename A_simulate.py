...
def find_roots(f, a, b, threshold=10, step=0.05, tol=1e-5):
    """
...
# param1 = [3.1329, 126.446, 0.62864592, 3.8478435, np.array([17800.0, 0.0, 1800.0])]
# param2 = [3.1329, 126.446, 3.87537403, 5.061331, np.array([17800.0, 0.0, 1800.0])]
# param3 = [3.1329, 126.446, 9.27616791, 3.96646362, np.array([17800.0, 0.0, 1800.0])]
# param4 = [np.pi, 120.0, 1.5, 3.6, np.array([17800.0, 0.0, 1800.0])]
param1 = [0.127165, 158.163254, 0, 0.642640, np.array([17800.0, 0.0, 1800.0])]
param2 = [4.016468, 140.000000, 4.592267, 7.884428,  np.array([12000.0 ,1400.0 ,1400.0])]
param3 = [ 1.7348272, 107.65982742, 24.21614147, 4.15451903, np.array([6000, -3000, 700])]
...
for param in params:
    ...
    roots = find_roots(dis_func, a=t_explode - 1, b=t_explode + 20, threshold=10, step=0.1)
    if(len(roots) > 0):
